...
\begin{document}
	...
	\begin{titlepage}
		...
		\frame{\includegraphics[width = 0.5 \textwidth]{fotos/foto3.jpg}}
		\\[.5 cm]
...
\section*{Zielsetzung}%\addcontentsline{toc}{section}{Zielsetzung}
...
\section*{Anhang}\label{ch:Anhang}%\addcontentsline{toc}{section}{Anhang}
%\FloatBarrier
	\begin{figure}[ht]
	\centering
	% Erste Zeile mit zwei Unterabbildungen
