...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Starten des PCs und des Programms "PK-Prakt.vi" zur Steuerung des Experiments.
    ...
    \begin{itemize}
        \item Einschalten des Lasers über das "RF \& Laser Control"-Feld im Programm.
    ...
    \begin{itemize}
        \item Feineinstellung des Drucks durch Gaszufuhr und Anpassung über das "Pressure Control"-Feld.
